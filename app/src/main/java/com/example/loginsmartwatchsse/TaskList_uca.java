...
import static com.example.loginsmartwatchsse.R.id.position;
import static com.example.loginsmartwatchsse.R.id.start;

public class TaskList_uca extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<String> arrayList_detShortID = new ArrayList<>();
        ArrayList<Integer> arrayList1 = new ArrayList<>();
        ArrayList<Integer> arrayList_tasks = new ArrayList<>();
        ArrayList<String> arrayList_descr = new ArrayList<>();
                ...
                if (response.isSuccessful()) {
                    try {
                        ...
                        for (int j = 0; j < jsonArray.length(); j++) {
                            ...
                            arrayList_detShortID.add(det_short_ID);
                            arrayList_tasks.add(task_id);
                            arrayList1.add(task_status_ID);
                            arrayList_descr.add(task_descr);
                                        ...
                                        if (oper_ID == operator_id) {
                                            if (current_activity == det_short_id) {
                                                if (status.equals("OK")) {
                                                    ...
                                                    Intent intent2 = new Intent(TaskList_uca.this, OrderDetails.class);
                                                    finish();
                            ...
                            TaskList_uca.this.runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    ...
                                    ArrayAdapter adapter = new ArrayAdapter(TaskList_uca.this, R.layout.row, R.id.kit_id, arrayList_detShortID) {
                                        @NonNull
                                        @Override
                                        public View getView(int position, View convertView, ViewGroup parent) {
                                            ...
                                            if (status_id == 2) {
                                                ...
                                                if (c == 0) {
                                                    ...
                                                    int position_curr_act = position;
                                            ...
                                            view.setOnClickListener(new View.OnClickListener() {
                                                ...
                                                public void onClick(View v) {
                                                    System.out.println("è entrato nel setonclicklistener");
                                                    Calendar calendar = Calendar.getInstance();
                                                    SimpleDateFormat format = new SimpleDateFormat("HH:mm:ss:SSS");
                                                    String timeRicezione = format.format(calendar.getTime());

                                                    String task_descr = arrayList_descr.get(position);
                                                    Integer task_id = arrayList_tasks.get(position);

                                                    Intent intent = new Intent(TaskList_uca.this, Task_ToDo.class);
                                                    intent.putExtra("TASK_DESCR", task_descr);
                                                    intent.putExtra("TIME_RICEZ", timeRicezione);
                                        ...
                                        public void onMessage(@NonNull com.example.loginsmartwatchsse.MessageEvent event) {
                                            ...
                                            try {
                                                ...
                                                if (oper_ID == operator_id) {
                                                    if (task_ID == task_id) {
                                                        if (status.equals("OK")) {
                                                            //deve fare autorefresh solo per il primo dei due task
                                                            //per il secondo task invece, una volta completato, deve tornare alla lista degli ordini
                                                            if (kit_Name.equals("UC-A oper Alberi check OK")) {
                                                                //qui fare autorefresh
                                                                arrayListColore.clear();
                                                                ...
                                                                //Intent intent = new Intent (TaskList_uca.this, OrderList_uca.class);
                        ...
                        for (int k=0; k<jsonArray.length(); k++){
                            if (arrayList1.get(k)==2){
                                counter ++;
                            }
                            if (counter == 2){
                                System.out.println("COUNTER E' UGUALE A 2");
                                //Intent intent = new Intent (TaskList_uca.this, OrderList_uca.class);
                                finish();
                                break;
                            }
        ...
        chiudi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1 = new Intent(TaskList_uca.this, OrderList.class);
                finish();
            }
        });
    }
